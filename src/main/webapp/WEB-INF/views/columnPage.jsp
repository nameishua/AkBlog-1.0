...
<head>
    ...
    <audio src="<%=contextPath%>/static/music/music3.mp3" id="bgAudio" hidden="true" autoplay="true" loop="true"></audio>
</head>
<body>
<script>
...
<div id="row1" class="container">
    <c:forEach var="article" items="${articles}">
        <div>
            <input type="hidden" value="${article.categoryId}" id="categoryId2" name="categoryId">
        </div>
    </c:forEach>
...
<script type="text/javascript">
    ...
    $(function(){
        $("#uppage").click(function(){
            ...
            var categoryid = parseInt(catid);
            var currentPage = parseInt(Page);
            /*console.log(currentPage);*/
            showMain(currentPage - 1,categoryid);
        });
    ...
    function showMain(currentPage,categoryid){
        ...
        $.ajax({
            url:"/page",
            type:"get",
            data:"currentPage=" + currentPage +"&categoryId=" +categoryid,
            dataType:"json",
            success:function(data) {
                ...
                item2 = "<input type='hidden' value='"+data.currentPage+"' id='thecurrentPage' name='thecurrentPage'>"
                    ...
                    +"<input type='hidden' value='"+data.categoryId+"' id='categoryId' name='categoryId'>"
...
<script>
    $(function(){
        var catid = $("#categoryId2").val();
        var categoryid = parseInt(catid);
        showMain(1,categoryid);
    });
</script>
